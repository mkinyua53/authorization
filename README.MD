...
Change the protected namespace attribute in ```app\Providers\RouteServiceProvider``` to an empty string
...
Update your routes accordingly to include the ```app\Http\Controllers``` namespace
